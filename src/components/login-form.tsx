...
export function LoginForm({ oauthError }: { oauthError?: string }) {
  ...
  return (
    <div className="login-shell flex flex-col lg:grid lg:h-auto lg:min-h-dvh lg:grid-cols-2">
      <BrandPanel />
      <section className="relative z-10 min-h-0 flex-1 bg-paper-raised lg:flex lg:flex-col lg:items-center lg:justify-center lg:bg-paper lg:px-8 lg:py-10">
        <div className="flex flex-col rounded-t-[32px] bg-paper-raised px-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] pt-3 shadow-[0_-18px_48px_rgba(28,20,18,0.42),0_-4px_12px_rgba(28,20,18,0.18)] max-lg:absolute max-lg:inset-x-0 max-lg:bottom-0 max-lg:top-[-2rem] lg:relative lg:w-full lg:max-w-[420px] lg:rounded-[28px] lg:border lg:border-white/70 lg:p-8 lg:shadow-[0_24px_60px_-32px_rgba(40,24,20,0.4)]">
